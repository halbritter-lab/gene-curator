    ...
    <v-container>
          ...
          >
            <template #item="{ props, item }">
              <v-list-item v-bind="props">
                ...
                <v-list-item-subtitle
                  >{{ item.raw.mode_of_inheritance }} •
                  {{ item.raw.lumping_splitting_decision }}</v-list-item-subtitle
                >
              </v-list-item>
            </template>
          </v-autocomplete>
      ...
      <v-row>
        <v-col cols="12">
          ...
          <ClinGenEvidenceForm v-model="formData.details" @update:model-value="updateEvidence" />
        </v-col>
      </v-row>
      ...
      <v-row v-if="scorePreview">
        <v-col cols="12">
          ...
          <ClinGenScoreCard :score="scorePreview" :show-actions="false" />
        </v-col>
      </v-row>
