                ...
                <v-card-text>
                  <v-row>
                    ...
                    <v-col cols="12" md="6">
                      ...
                      <div class="mb-4">
                        <div class="text-caption text-medium-emphasis">Lumping/Splitting Decision</div>
                        <v-chip
                          :color="getDecisionColor(precuration.lumping_splitting_decision)"
                          :variant="precuration.lumping_splitting_decision === 'Undecided' ? 'outlined' : 'tonal'"
                          class="mt-1"
                        >
              ...
              <v-card>
                ...
                <v-card-text>
                  <v-row>
                    <v-col cols="12" md="3">
                      <div class="text-caption text-medium-emphasis">Gene Symbol</div>
                      <div class="text-body-1 font-weight-medium">{{ precuration.gene.approved_symbol }}</div>
                    </v-col>
                    <v-col cols="12" md="3">
                    ...
                    <v-col cols="12" md="3">
                      ...
                      <div class="text-body-1">{{ precuration.gene.current_dyadic_name || 'Not set' }}</div>
                    </v-col>
                  </v-row>
                </v-card-text>
              </v-card>
          ...
          <v-row class="mb-6">
            <v-col cols="12">
              <v-card>
                ...
                <v-card-text>
                  <div class="text-body-1 whitespace-pre-wrap">{{ precuration.rationale || 'No rationale provided' }}</div>
                </v-card-text>
              </v-card>
            </v-col>
          </v-row>
                  ...
                  <v-row>
                    ...
                    <v-col cols="12" md="4">
                      ...
                      <div class="text-body-1">
                        ...
                        <span v-if="!precuration.contributors?.length" class="text-medium-emphasis">None</span>
                      </div>
                    </v-col>
                  </v-row>
                </v-card-text>
...
const canEdit = computed(() => {
  return authStore.isCurator && precuration.value && ['Draft', 'In_Primary_Review'].includes(precuration.value.status)
})
