-- Schema-Agnostic Gene Curator Database Schema
-- Scope-Based Multi-Stage Workflow with 4-Eyes Principle
-- PostgreSQL 15+
...
-- ========================================
-- ENUM TYPES FOR SCHEMA-AGNOSTIC ARCHITECTURE
-- ========================================
